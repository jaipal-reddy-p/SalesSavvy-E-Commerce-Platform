...
public class OrderService {
	...
	public Map<String, Object> getOrdersForUser(User user) {
		...
		response.put("role", user.getRole()); // Directly use the role as it is an enun mapped to a string
		...
		// Add the products list to the response response.put("products", products);
